...
import { Processing } from '/api/coins'
...
import SummaryDefault from '/components/views/Processing/Summary'
import SendDefault from '/components/views/Processing/Send'
import AddressesDefault from '/components/views/Processing/Addresses'
import ExportDefault from '/components/views/Processing/Export'
import SettingsDefault from '/components/views/Processing/Settings'
